...
namespace TMS
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string> {
         ConfigurationManager.AppSettings["PrimaryLanguageCode"].ToString()==null ?ConfigurationManager.AppSettings["PrimaryLanguageCode"].ToString():"en-US",// first culture is the DEFAULT
         ConfigurationManager.AppSettings["SecondryLanguageCode"].ToString()==null ?ConfigurationManager.AppSettings["SecondryLanguageCode"].ToString():"ar-KW",
        ...
        public static bool IsPrimaryLanguage()
        {
            return GetDefaultCulture() == GetCurrentCulture() ? true : false;
        }
