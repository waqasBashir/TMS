...
namespace TMS.Library.TMS.Persons
{
    ...
    public class Prospect : IDataMapper
    {
        #region //JUNK
        //public class Users
        //{
        ...
        public Salutation SalutationID
        {
            get; set;
        }
        ...
        //public IList<CoordinatorMapping> coordinate { get; set; }
        /// <summary>
     ...
     //   [Display(Name = "Assigned To", ResourceType = typeof(lr))]
        ...
        //public IList<CRM_Prospect> Prospect { get; set; }

        //public CRM_Prospect Prospects { get; set; }
    ...
    /// </summary>
    public class PersonFlagsModels
    {
        /// <summary>
    ...
    /// </summary>
    public class PersonAttachments
    {
        /// <summary>
    ...
    /// </summary>
    public class AttachmentPersonDatas
    {
        /// <summary>
    ...
    /// </summary>
    public class PersonRolesMappings
    {
        /// <summary>
        /// Gets or sets the identifier.
        /// </summary>
    ...
    public class CoordinatorMappings
    {
        /// <summary>
        /// Gets or sets the identifier.
        /// </summary>
